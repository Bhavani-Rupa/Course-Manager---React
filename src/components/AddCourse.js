// AddCourse component
// Presents a validated form and submits a new course to JSON Server
...
function AddCourse() {
  ...
  // Client-side validation for basic correctness
  const validateForm = () => {
    const newErrors = {};
    if (title.length < 3) {
  ...
  // Submit new course to backend and navigate back to list
  ...
  return (
    <div>
      ...
      {/* noValidate disables browser-native tooltips in favor of our custom messages */}
