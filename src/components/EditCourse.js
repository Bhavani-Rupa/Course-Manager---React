...
// Loads an existing course by :id, validates edits, and updates via JSON Server
...
function EditCourse() {
  ...
  // Loading state while fetching the existing course
  ...
  useEffect(() => {
    // Fetch the existing course to prefill the form
